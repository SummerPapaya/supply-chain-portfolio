...
- 🔀 **多模型对比** — 同一命题，五款独立 AI 工具。横向对比矩阵清晰呈现每个模型的视角、数据来源与标志性特征。
- 🔓 **完全开放** — 全部六个源仓库均托管于 GitHub。每一个论断都可追溯到一手来源——不虚构、不暗箱替换数据。

## 🔬 研究报告作品集

五份报告，五种 AI 思维，一个命题。每份报告都是一个自包含、可渲染的 HTML 仪表盘，可在新标签页中打开。
...
scripts/                     # 雷达数据刷新 + 飞书自动入库
assets/                      # README 封面 SVG（用于仓库根目录）
README.md / README.zh-cn.md  # 中英双语作品集说明
```
...
<p align="center">
  <em>作为一个持续演进的实验而构建：一个命题，五种 AI 思维，一个开放的仓库。</em><br>
